<!-- 🌌 Arivalagan Sankar - Futuristic Full-Stack Engineer -->
...
## 📬 Contact
- Email: arivalagansankar.dev@gmail.com  
- LinkedIn: https://www.linkedin.com/in/arivalagan-sankar-339012380  
- GitHub: https://github.com/arivalagan-tech

**Download Resume:**  
[📄 Arivalagan_Sankar_Resume.pdf](https://github.com/arivalagan-tech/arivalagan-tech/raw/main/assets/Arivalagan_Sankar_Resume.pdf)
...
|-----------|-----------|-----------|---------------|--------|
| HTML5, CSS3, JavaScript (ES6+), React.js, React Hooks, Tailwind CSS, Bootstrap | Node.js, Express.js, REST APIs, JSON, Middleware | MongoDB & Atlas, PostgreSQL | AWS (S3, CloudFront basics), Vercel, Netlify, GitHub Actions, Docker (basics), DSA fundamentals | Figma, Postman, Git/GitHub, Jest (unit testing) |
